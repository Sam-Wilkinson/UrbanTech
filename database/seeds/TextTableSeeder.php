    ...
    public function run()
    {
        DB::table('texts')->insert([
            ...
            [
                ...
                'content_fr' => "",
                'content_nl' => "",
                'position' => "contact_section1_name",
            ],
            [
                'content_en' => "Rue des vétérinaires 45",
                'content_fr' => "",
                'content_nl' => "",
                'position' => "contact_section1_street",
            ],
            [
                'content_en' => "1070 Brussels",
                'content_fr' => "1070 Bruxelles",
                'content_nl' => "Brussel",
                'position' => "contact_section1_city",
            ],
            [
                'content_en' => "Belgium",
                'content_fr' => "Belgique",
                'content_nl' => "België",
                'position' => "contact_section1_country",
            ],
            [
                'content_en' => "02 411 02 22",
                'content_fr' => "",
                'content_nl' => "",
                'position' => "contact_section1_phone",
            ],
            [
                'content_en' => "02 378 27 81",
                'content_fr' => "",
                'content_nl' => "",
                'position' => "contact_section1_fax",
            ],
            [
                'content_en' => "contact@urbantech.be",
                'content_fr' => "",
                'content_nl' => "",
                'position' => "contact_section1_email",
            ],
            [
