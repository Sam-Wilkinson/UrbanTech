...
<form method="POST" action="{{route('jobs.store')}}" enctype="multipart/form-data" >
    ...
    <div class="tab-content box" id="nav-tabContent">
                    ...
                    <div class="p-1 my-2">
                        ...
                        <div class="p-1 my-1">
                            ...
                            <div class="p-1 my-1">
                                    ...
                                    @foreach($categories as $category)
                                        <div class="border bg-light p-3 mx-2">
                                            <input type="radio" id="category" name="category" value="{{$category->id}}"><label for="coding">{{$category->name_fr}}</label>
                                        </div>
                                    @endforeach
                                    @can('admin-only')
                                    <div class="border bg-light p-3 mx-2">
            ...
            <div class="tab-pane fade" id="nav-dutch" role="tabpanel" aria-labelledby="nav-dutch-tab">
                    <div class="p-1 my-2">
